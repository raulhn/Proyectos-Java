...
} from "./chunk-VG2KDLB7.js";
import {
  DataTableComponent,
  init_datatable_component
} from "./chunk-QMTRLPG2.js";
import {
  EVENT_MANAGER_PLUGINS,
  EventManagerPlugin,
  init_dom_renderer
} from "./chunk-YZNCFB4O.js";
import {
  BehaviorSubject,
  ChangeDetectorRef,
  Compiler,
...
<app-datatable [data]="largeSampleData"></app-datatable>
    <app-search-select [options]="searchOptions" placeholder="Search options" (selectionChange)="onSelect($event)"></app-search-select>
    </div>
...
var init_app3 = __esm({
  "src/app/app.ts"() {
    ...
    App = class App2 {
      ...
      largeSampleData = Array.from({ length: 20 }, (_, i) => ({
        id: i + 1,
        name: `Name${i + 1}`,
        age: 20 + i % 30,
    ...
    App = __decorate([
      Component({
        selector: "app-root",
        imports: [RouterOutlet, DataTableComponent, SearchSelectComponent],

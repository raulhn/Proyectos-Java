...
// node_modules/.pnpm/@angular+platform-browser@20.3.25_@angular+common@20.3.25_@angular+core@20.3.25_@angula_1394d74d15c42e61296d8e4b0cb92823/node_modules/@angular/platform-browser/fesm2022/testing.mjs
init_common();

// node_modules/.pnpm/@angular+common@20.3.25_@angular+core@20.3.25_@angular+compiler@20.3.25_rxjs@7.8.2_zone.js@0.15.1__rxjs@7.8.2/node_modules/@angular/common/fesm2022/testing.mjs
init_common();
init_core();
init_core();
init_esm();
...
var MockPlatformLocation = class _MockPlatformLocation {
  ...
  static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.3.25", ngImport: core_exports, type: _MockPlatformLocation, deps: [{ token: MOCK_PLATFORM_LOCATION_CONFIG, optional: true }], target: FactoryTarget.Injectable });
  static \u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.3.25", ngImport: core_exports, type: _MockPlatformLocation });
};
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.25", ngImport: core_exports, type: MockPlatformLocation, decorators: [{
  type: Injectable
...
var FakeNavigationPlatformLocation = class _FakeNavigationPlatformLocation {
  ...
  static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.3.25", ngImport: core_exports, type: _FakeNavigationPlatformLocation, deps: [], target: FactoryTarget.Injectable });
  static \u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.3.25", ngImport: core_exports, type: _FakeNavigationPlatformLocation });
};
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.25", ngImport: core_exports, type: FakeNavigationPlatformLocation, decorators: [{
  type: Injectable
}], ctorParameters: () => [] });
...
var SpyLocation = class _SpyLocation {
  ...
  static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.3.25", ngImport: core_exports, type: _SpyLocation, deps: [], target: FactoryTarget.Injectable });
  static \u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.3.25", ngImport: core_exports, type: _SpyLocation });
};
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.25", ngImport: core_exports, type: SpyLocation, decorators: [{
  type: Injectable
}] });
...
var MockLocationStrategy = class _MockLocationStrategy extends LocationStrategy {
  ...
  static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.3.25", ngImport: core_exports, type: _MockLocationStrategy, deps: [], target: FactoryTarget.Injectable });
  static \u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.3.25", ngImport: core_exports, type: _MockLocationStrategy });
};
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.25", ngImport: core_exports, type: MockLocationStrategy, decorators: [{
  type: Injectable
}], ctorParameters: () => [] });
...
var DOMTestComponentRenderer = class _DOMTestComponentRenderer extends TestComponentRenderer {
  ...
  static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.3.25", ngImport: core_exports, type: _DOMTestComponentRenderer, deps: [{ token: DOCUMENT }], target: FactoryTarget.Injectable });
  static \u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.3.25", ngImport: core_exports, type: _DOMTestComponentRenderer });
};
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.25", ngImport: core_exports, type: DOMTestComponentRenderer, decorators: [{
  type: Injectable
}], ctorParameters: () => [{ type: void 0, decorators: [{
  type: Inject,
  args: [DOCUMENT]
...
var BrowserTestingModule = class _BrowserTestingModule {
  static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.3.25", ngImport: core_exports, type: _BrowserTestingModule, deps: [], target: FactoryTarget.NgModule });
  static \u0275mod = \u0275\u0275ngDeclareNgModule({ minVersion: "14.0.0", version: "20.3.25", ngImport: core_exports, type: _BrowserTestingModule, exports: [BrowserModule] });
  static \u0275inj = \u0275\u0275ngDeclareInjector({ minVersion: "12.0.0", version: "20.3.25", ngImport: core_exports, type: _BrowserTestingModule, providers: [
...
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.25", ngImport: core_exports, type: BrowserTestingModule, decorators: [{
  type: NgModule,
  args: [{

...
var init_datatable_component = __esm({
  ...
  @if (totalPages > 1) {
    <div class="pagination">
      <button type="button" (click)="goToPage(1)" [disabled]="currentPage===1">1</button>
      ...
      <button type="button" (click)="goToPage(totalPages)" [disabled]="currentPage===totalPages">{{totalPages}}</button>
    </div>
  }
...
//# sourceMappingURL=chunk-7OTQZMF3.js.map
